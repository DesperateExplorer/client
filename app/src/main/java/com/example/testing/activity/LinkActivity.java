            ...
            public void onClick(View view) {
                ...
                call.enqueue(new Callback() {
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        ...
                        Log.d(this.getClass().getSimpleName(), jsonObject.getAsString()); // debug
//                        _this.runOnUiThread(new Runnable() {
//                            @Override
//                            public void run()  {
//                                Toast.makeText(getApplicationContext(), jsonObject.getAsString().substring(0, 8), Toast.LENGTH_SHORT).show(); // for debug
//                            }
//                        });
                    }
                });
